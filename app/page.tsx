...
const heroSlides = [
  {
    ...
    description: "Source food, livestock, and essentials together with verified contribution pools. Food Mart handles the logistics so you stay focused on your community.",
  ...
  },
  {
    ...
    description:
      "Bundle demand across towns, lock in wholesale rates, and split the benefits fairly. Food Mart connects you to trusted vendors.",
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-blue-50">
      ...
      <section className="relative min-h-[70vh] overflow-hidden">
        {heroSlides.map((slide, index) => (
          ...
          >
            ...
            />
            <div className="relative max-w-360 mx-auto px-4 sm:px-6 lg:px-8 h-[70vh] min-h-[520px] flex flex-col justify-center text-white">
      ...
      <section id="how-it-works" className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white">
      ...
      {/* Features Section */}
      <section id="features" className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Why Choose Food Mart
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-20">

        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 px-6 py-4 text-center font-semibold transition-colors ${accountType === "user"
            ...
            <button
              ...
              className={`flex-1 px-6 py-4 text-center font-semibold transition-colors ${accountType === "creator"
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-3 rounded-lg font-semibold text-white transition-colors ${accountType === "creator"
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  ...
                  className={`font-semibold ${accountType === "creator"

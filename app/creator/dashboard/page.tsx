          ...
          <div className="flex overflow-x-auto">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-4 font-medium text-sm whitespace-nowrap border-b-2 transition ${activeTab === tab.id
            ...
            <form onSubmit={handleUpdateSettings} className="p-4 sm:p-6 space-y-5">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-semibold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors ${settingsLoading ? "opacity-60 cursor-not-allowed" : ""
                    }`}
                >

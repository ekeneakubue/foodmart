          ...
          <div className="rounded-3xl overflow-hidden shadow-2xl border border-white">
            ...
            <div className="bg-white px-4 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-8">
              <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 uppercase tracking-widest">
                <span className={`rounded-full border px-3 py-1 text-xs font-semibold ${pool.category === "FOOD_STUFFS"
              ...
              <div className="mt-8">
                {user ? (
                  <button
                    ...
                    disabled={isPoolFull}
                    className={`w-full rounded-2xl px-6 py-4 text-center text-lg font-semibold shadow-lg transition ${isPoolFull
          ...
          <aside className="space-y-8">
            ...
            <div className="rounded-2xl border border-gray-100 bg-white/80 p-6 shadow-lg">
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="rounded-xl bg-gray-50 p-4 border border-gray-100">
                  ...
                  <span className={`inline-block mt-1 px-3 py-1 rounded-full text-xs font-semibold ${pool.status === "ACTIVE"
            ...
            <div className="rounded-2xl border border-green-100 bg-green-50 p-6 shadow-inner">
              ...
              <p className="mt-3 text-base text-green-900">
                This pool is managed and verified by Food Mart's trust & safety team.
              </p>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {toast.show && (
        <div className="fixed top-4 right-4 z-[100] animate-in slide-in-from-top-2 fade-in duration-300">
          <div className={`flex items-start gap-4 p-4 rounded-xl shadow-2xl border backdrop-blur-sm max-w-sm ${toast.type === "success"
              ? "bg-green-50/95 border-green-200"
              : "bg-red-50/95 border-red-200"
            }`}>
            <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${toast.type === "success"
                ? "bg-green-100"
                : "bg-red-100"
              }`}>
              {toast.type === "success" ? (
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={`mt-1 text-sm ${toast.type === "success" ? "text-green-600" : "text-red-600"
                }`}>
                {toast.message}
              </p>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="p-8 text-center">
              <div className="mb-6">
                <p className="text-gray-600 mb-2">Welcome to Food Mart</p>
        ...
        `}>
          <nav className="p-4 space-y-2 pt-20 lg:pt-4">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${activeTab === "pools"
                  ? "bg-green-50 text-green-700 font-semibold"
                  : "text-gray-700 hover:bg-gray-50"
                }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${activeTab === "creators"
                  ? "bg-green-50 text-green-700 font-semibold"
                  : "text-gray-700 hover:bg-gray-50"
                }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${activeTab === "teams"
                  ? "bg-green-50 text-green-700 font-semibold"
                  : "text-gray-700 hover:bg-gray-50"
                }`}
            >
            ...
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${activeTab === "transactions"
                  ? "bg-green-50 text-green-700 font-semibold"
                  : "text-gray-700 hover:bg-gray-50"
                }`}
            >
                        ...
                        pools.map((pool) => {
                          ...
                          return (
                            <tr key={pool.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4">
                                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${pool.category === "FOOD_STUFFS"
                              ...
                              <td className="px-6 py-4">
                                <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${pool.status === "ACTIVE"
                      ...
                      {usersLoading ? (
                        ...
                        users.map((user) => (
                          <tr key={user.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4">
                              <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${user.status === "ACTIVE"
                                  ? "bg-green-100 text-green-700 border-green-200"
                      ...
                      {creatorsLoading ? (
                        ...
                        creators.map((creator) => (
                          <tr key={creator.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4">
                              <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${creator.status === "VERIFIED"
                                  ? "bg-green-100 text-green-700 border-green-200"
            ...
            <div className="px-8 py-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${selectedPool.category === "FOOD_STUFFS"
                      ? "bg-green-100 text-green-700"
                      : "bg-blue-100 text-blue-700"
                    }`}>
                ...
                <div>
                  ...
                  <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold border ${selectedPool.status === "ACTIVE"
                      ? "bg-green-100 text-green-700 border-green-200"
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="p-6">
              <div className="flex flex-col items-center mb-6">
                ...
                <span className={`mt-1 px-3 py-1 rounded-full text-xs font-semibold ${selectedUser.status === "ACTIVE"
                    ? "bg-green-100 text-green-700"
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-semibold ${selectedUser.role === "ADMIN"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <span className={`mt-2 inline-block px-4 py-1.5 rounded-full text-sm font-semibold ${selectedCreator.status === "VERIFIED"
                        ? "bg-green-100 text-green-700"

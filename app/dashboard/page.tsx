        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center">
              <img src="/images/logo.png" alt="Food Mart" className="h-10" />
            </Link>
          ...
          <div className="border-b border-gray-100 px-6 pt-4">
            <div className="flex gap-6">
              <button
                ...
                className={`pb-4 px-2 font-medium text-sm transition border-b-2 ${activeTab === "all"
              ...
              <button
                ...
                className={`pb-4 px-2 font-medium text-sm transition border-b-2 ${activeTab === "active"
                    ? "border-emerald-500 text-emerald-600"
                    : "border-transparent text-gray-500 hover:text-gray-700"
                  }`}
              >
              ...
              <button
                ...
                className={`pb-4 px-2 font-medium text-sm transition border-b-2 ${activeTab === "completed"
                    ? "border-emerald-500 text-emerald-600"
                    : "border-transparent text-gray-500 hover:text-gray-700"
                  }`}
              >
          ...
          <form onSubmit={handleUpdateSettings} className="p-6 space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all text-gray-900 placeholder:text-gray-400 pr-12 ${currentPasswordStatus !== "valid" ? "bg-gray-50 cursor-not-allowed" : ""
                      }`}
                  />
                  <button
                    type="button"
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`px-6 py-3 rounded-lg font-semibold text-white bg-green-600 hover:bg-green-700 transition-colors ${settingsLoading ? "opacity-60 cursor-not-allowed" : ""
                  }`}
              >
